...
if (ENABLE_OPENCL)
    ...
    if(ENABLE_PYBIND11)
        target_compile_definitions (pureqrack PUBLIC CL_HPP_TARGET_OPENCL_VERSION=200)
        target_compile_definitions (pureqrack PUBLIC CL_HPP_MINIMUM_OPENCL_VERSION=110)
    ...
    if (ENABLE_SNUCL)
        ...
        if(ENABLE_PYBIND11)
            target_link_directories (pureqrack PRIVATE ${QRACK_OpenCL_LINK_DIRS})
        endif(ENABLE_PYBIND11)
    ...
    if(ENABLE_PYBIND11)
        target_link_libraries (pureqrack ${QRACK_OpenCL_LIBRARIES})
    endif(ENABLE_PYBIND11)
